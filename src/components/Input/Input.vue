	...
	<div class="vk-input" :class="{
		...
		<template v-if="type !== 'textarea'">
			...
			<div class="vk-input__wrapper">
				...
				<input class="vk-input__inner" v-bind="attrs"
					...
					:disabled="disabled" v-model="innerValue" @input="handleInput" @focus="handleFocus" @blur="handleBlur"
		...
		<!-- textarea -->
		<template v-else>
			<textarea class="vk-textarea__wrapper" v-bind="attrs" :readonly="readonly" :autocomplete="autocomplete"
				:placeholder="placeholder" :autofocus="autofocus" :form="form" :disabled="disabled" v-model="innerValue"
...
import { ref, watch, computed, useAttrs, nextTick, type Ref, inject } from 'vue'
import type { InputProps, InputEmits } from './types';
import Icon from '../Icon/Icon.vue';
import { formItemContextKey } from '../Form/types'

defineOptions({ name: 'VkInput', inheritAttrs: false })
